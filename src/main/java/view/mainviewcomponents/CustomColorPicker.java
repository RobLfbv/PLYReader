...
/**
 * Classe qui represente un colorpicker qui ne possede pas les options de
 * couleurs personalisees (qui faisent crasher notre application a cause d'un
 * bug dans javafx) Bug : https://bugs.openjdk.java.net/browse/JDK-8095838
 * 
 * modifiee a partir de :
...
public class CustomColorPicker extends ColorPicker {
	...
	/**
	 * Cree un color picker custom
	 * 
	 * @param color - la couleur a mettre dans le couleur picker
	 */
